...
media = client.process(
    original_path="data_samples/face_live_video/real/1.mp4",
    model_type="FI-1",
    livenessCheck=True,
    auto_polling=True,
)
...
print(DIVIDER)
media = client.process(
    original_path="data_samples/face_live_video/fake/1.mp4",
    model_type="FI-1",
    livenessCheck=True,
    auto_polling=True,
)
...
print(DIVIDER)
media = client.process(
    original_path="data_samples/faceswap/fake/1.mp4",
    model_type="FI-1",
    faceswapCheck=True,
    auto_polling=True,
)
...
print(DIVIDER)
media = client.process(
    original_path="data_samples/faceswap/real/1.mp4",
    model_type="FI-1",
    faceswapCheck=True,
    auto_polling=True,
)
...
print(DIVIDER)
media = client.process(
    original_path="data_samples/face_similiar/person_1/A.jpeg",
    reference_path="data_samples/face_similiar/person_1/B.jpeg",
    model_type="FI-1",
...
media = client.process(
    original_path="data_samples/face_similiar/person_1/A.jpeg",
    reference_path="data_samples/face_similiar/person_2/A.jpeg",
    model_type="FI-1",
    faceSimilarityCheck=True,
    auto_polling=True,
)
